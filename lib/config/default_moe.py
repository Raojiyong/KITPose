...
_C.MODEL.INIT = True
_C.MODEL.PRETRAINED = ''
_C.MODEL.NUM_JOINTS = [17, 20, 23]
_C.MODEL.MAX_NUM_JOINTS = 23
_C.MODEL.NUM_BP = [4, 5, 6]
_C.MODEL.MAX_NUM_BP = 6
_C.MODEL.NUM_EXPERTS = 4
...
# Mixing Training set
_C.DATASET.MIX_DATA = CN()
_C.DATASET.MIX_DATA.CONFIG = [
    dict(
        name='ap10k',
        root='data/ap10k/',
        train_set='train',
...
def update_config_moe(cfg, args):
    cfg.defrost()
