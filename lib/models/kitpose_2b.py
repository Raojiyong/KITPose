...
class KITPose_base(nn.Module):
    def __init__(self, *, feature_size, num_keypoints, dim, depth, heads, mlp_dim, apply_init=False,
        ...
        num_patches = num_keypoints * 2
        patch_dim = feature_size[0] * feature_size[1]
...
class KITPose(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.channelformer = KITPose_base(
            ...
            hidden_heatmap_dim=cfg.MODEL.HEATMAP_SIZE[0] * cfg.MODEL.HEATMAP_SIZE[1] // 8,
            heatmap_dim=cfg.MODEL.HEATMAP_SIZE[0] * cfg.MODEL.HEATMAP_SIZE[1],
            heatmap_size=[cfg.MODEL.HEATMAP_SIZE[0], cfg.MODEL.HEATMAP_SIZE[1]],
