...
from core.function_part import train
from core.function_part import validate
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        wandb_train_log = train(cfg, train_loader, model, critetion_kpt, criterion_part, optimizer, epoch,
                                final_output_dir, tb_log_dir, wandb, writer_dict=writer_dict)

        # evaluate on validation set
        perf_indicator, wandb_val_log = validate(
            cfg, valid_loader, valid_dataset, model, critetion_kpt,
