...
def main():
    ...
    if cfg.TEST.MODEL_FILE:
        ...
        with open('ex2.json', 'w') as f:
            json.dump(list(existing_state_dict.keys()), f)
        model.load_state_dict(existing_state_dict, strict=True)
    ...
    # joints_weight = load_file[1].data
    # logger.info('=> the joints weight is {}'.format(joints_weight.transpose(0, 1)))
    ...
    #          final_output_dir, joints_weight, tb_log_dir)
    validate(cfg, valid_loader, valid_dataset, model, criterion,
