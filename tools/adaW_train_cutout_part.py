...
from core.function_cutout_part import train_cutout
from core.function_cutout_part import validate
...
def main():
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train for one epoch
        wandb_train_log = train_cutout(cfg, train_loader, model, criterion_kpt, criterion_part, optimizer, epoch,
