...
def main():
    ...
    lr_scheduler = build_scheduler(cfg, optimizer, n_iter_per_epoch)
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        t = epoch * n_iter_per_epoch
        logger.info("=> the first lr is {:.6f}".format(
            lr_scheduler._get_lr(t)[0]
        ))

        # train for one epoch
        wandb_train_log = train(cfg, train_loader, model, criterion, optimizer, epoch,
        ...
        wandb_log['lr'] = lr_scheduler._get_lr(t)[0]
